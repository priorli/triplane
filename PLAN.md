...
> **Note on phase numbering:** Phases 1–6 deliver v0.1. Phase 7 is iOS auth — the same gating role Phase 12.7 played in Travolp. Phase 8 delivers v0.2 (design system). Numbering is stable; never reused.
