...
// Next.js metadata route — generates the favicon at build / request time.
// Three-parallelogram mark + amber placeholder dot on white.
// Mirrors mobile/branding/generate-app-icons.ts geometry.
